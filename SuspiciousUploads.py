...
def makeSuspiciousExfiltrationQuery():
	...
	global CURRENT_TIME, START_TIME, PEER_COUNT_TIME, EXFIL_BYTE_COUNT, EXFIL_PEER_COUNT, TRUSTED_HOST_GROUP
	...
	(SELECT * FROM
		(SELECT *  FROM
			(SELECT
				...
				V6_NTOA(server_ip_address & V6_ATON('255.255.255.0')) AS server_subnet,
...
ON recent_low_peer_subnets.server_ip = uploads_to_outside.server_ip""".format(START_TIME, CURRENT_TIME, TRUSTED_HOST_GROUP, EXFIL_BYTE_COUNT, PEER_COUNT_TIME, CURRENT_TIME, START_TIME, EXFIL_PEER_COUNT)
