...
if __name__ == "__main__":
	...
	if CP_USERNAME is None:
		CP_USERNAME = raw_input("Checkpoint Username:")
	...
	if FMC_USERNAME is None:
		FMC_USERNAME = raw_input("Firepower Username:")
	...
	for host_uuid, host_json in HOST_OBJECTS.iteritems():
	...
	for network_uuid, network_json in NETWORK_OBJECTS.iteritems():
	...
	for address_range_uuid, address_range_json in ADDRESS_RANGE_OBJECTS.iteritems():
	...
	for group_uuid, group_json in GROUP_OBJECTS.iteritems():
